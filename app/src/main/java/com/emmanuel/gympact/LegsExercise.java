...
//Array to hold the if else statement outcomes
    ...
    if(exercise.length() < 1) {
        ...
        Toast.makeText(LegsExercise.this, "Enter exercise",
        ...
        Toast.makeText(LegsExercise.this, "Enter weight",
                Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(LegsExercise.this, "Enter number of repetitions",
                Toast.LENGTH_SHORT).show();

    }else if(isDataInserted == true)
        Toast.makeText(LegsExercise.this, "Data saved successfully", Toast.LENGTH_LONG).show();

        else

        Toast.makeText(LegsExercise.this, "Data insert unsuccessful", Toast.LENGTH_LONG).show();
        }
        });
        }
...
public void onClick(View v) {
        ...
        //display all data
        DisplayMessage("Leg Data", buffer.toString());
        }
        }
        );
...
public void onClick(View v) {
        ...
        Toast.makeText(LegsExercise.this, "Update Successful :)", Toast.LENGTH_LONG).show();

        else

        Toast.makeText(LegsExercise.this, "Update Unsuccessful :( ", Toast.LENGTH_LONG).show();
        }
        }
        );
...
public void onClick(View v) {
        ...
        if(rowsDeleted > 0)
        Toast.makeText(LegsExercise.this, "Deleted", Toast.LENGTH_LONG).show();

        else

        Toast.makeText(LegsExercise.this, "Error data does not exist", Toast.LENGTH_LONG).show();
