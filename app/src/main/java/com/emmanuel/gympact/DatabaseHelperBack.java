...
public class DatabaseHelperBack extends SQLiteOpenHelper {
    //constructor

    public static final String DATABASE_NAME = "Back.database";
    ...
    public DatabaseHelperBack(Context context) {
        //creates database
